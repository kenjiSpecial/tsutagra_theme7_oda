function map_calculation(data, fillColor, developed_country_status){
            ...
            for (var r_num in contries_supprted) {
                if (r_num < lastNum) {
                    ...
                    if (supported_money > 0) {
                        drawing_line(support_country, support_center, supported_center, supported_money / (support_money - sonotaMoney), fillColor)
                    }
...
//                -------------------
            ...
            for (var r_num in contries_supprted) {
                    ...
                    if (supported_money > 0) {
                        drawing_line(support_country, support_center, supported_center, supported_money / (support_money), fillColor)
                    }
...
//        drawing_circle(support_center, support_money, color_support);
        ...
        google.maps.event.addListener(support_country_circle, 'click', country_mouseover);
